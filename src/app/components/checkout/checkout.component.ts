...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private itemFormService: ItemFormService, private cartService: CartService, private checkoutService: CheckoutService, private router: Router) {}
  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      ...
      this.itemFormService.getCreditCardMonths(startMonth).subscribe(
        data =>{
      ...
      this.itemFormService.getCreditCardYear().subscribe(
        data =>{
      ...
      //populate countries
      this.itemFormService.getCountries().subscribe(
        data =>{
  ...
  getStates(formGroupName: string){
    ...
    this.itemFormService.getStates(countryCode).subscribe(
      data =>{
  ...
  onSubmit() {
    ...
    //call REST API throught the CheckoutService
